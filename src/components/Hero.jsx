...
function EcgLine() {
  return (
    <div className="overflow-hidden h-[60px] w-full rounded-md relative">
      <div
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#030309]">
        ...
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-violet-600/8 rounded-full blur-[150px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-cyan-500/8 rounded-full blur-[150px] pointer-events-none" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-violet-900/5 rounded-full blur-[200px] pointer-events-none" />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
        ...
        <div className="space-y-8 animate-fade-up">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#signup"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-violet-600 to-cyan-500 hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-violet-600/25"
            >
              Get Early Access
              <ArrowRight size={16} />
            </a>
        ...
        <div className="relative animate-fade-up" style={{ animationDelay: '0.15s' }}>
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-violet-600/20 to-cyan-500/10 rounded-3xl blur-2xl scale-105" />
          ...
          <div className="relative glass card-glow rounded-2xl p-5 space-y-5 overflow-hidden">
            ...
            <div className="flex items-start gap-3 p-3.5 bg-violet-500/8 border border-violet-500/20 rounded-xl">
              <div className="mt-0.5 w-5 h-5 rounded-full bg-violet-600 flex items-center justify-center flex-shrink-0">
