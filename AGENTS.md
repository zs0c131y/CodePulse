...
- **Database Schema & ERD** -> [docs/database/DATABASE.md](docs/database/DATABASE.md)
...
4. **Link references**: When citing code elements in your outputs or files, use project-relative file paths in standard Markdown format (e.g. `[App.jsx](src/App.jsx)`) so agents and developers can click them.
